...
const consultantInquiryRoutes = require('./routes/consultant-inquiries');
...
app.use('/api/consultant-applications', consultantApplicationRoutes); // 하이픈 포함 경로로 변경
...
app.use('/api/consultant-inquiries', consultantInquiryRoutes);
